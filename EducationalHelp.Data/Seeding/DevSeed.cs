...
namespace EducationalHelp.Data.Seeding
{
    internal static class DevSeed
    {
        public static void Seed(ModelBuilder builder)
        {
            ...
            {
                new User() { Id = new Guid("331DF5C7-9FBE-45E4-AF6D-02AFCFCB9C1D"), Pseudonym = "Жмышенко Валерий", PassHash = "a665a45920422f9d417e4867efdc4fb8a04a1f3fff1fa07e998e86f7f7a27ae3" }
            };
